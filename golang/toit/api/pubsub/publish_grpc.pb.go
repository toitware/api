...
func (c *publishClient) Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/toit.api.pubsub.Publish/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Publish_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/toit.api.pubsub.Publish/Publish",
	}
...
var Publish_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "toit.api.pubsub.Publish",
	...
	Metadata: "toit/api/pubsub/publish.proto",
}
