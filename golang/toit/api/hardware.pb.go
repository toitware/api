...
func (x *HardwareEvent) GetReceived() *timestamp.Timestamp {
	if x != nil {
		return x.Received
	}
	return nil
...
func (x *HardwareEvent) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *HardwareEventsRequest) GetTs() *timestamp.Timestamp {
...
type HardwareEventsRequest_Ts struct {
	Ts *timestamp.Timestamp `protobuf:"bytes,7,opt,name=ts,proto3,oneof"`
}
