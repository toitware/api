...
type DeviceConfig struct {
	...
	StartedAfter  *timestamp.Timestamp      `protobuf:"bytes,2,opt,name=started_after,json=startedAfter,proto3" json:"started_after,omitempty"`
	...
	FactoryAfter  *timestamp.Timestamp      `protobuf:"bytes,7,opt,name=factory_after,json=factoryAfter,proto3" json:"factory_after,omitempty"`
...
func (x *DeviceConfig) GetStartedAfter() *timestamp.Timestamp {
	if x != nil {
...
func (x *DeviceConfig) GetFactoryAfter() *timestamp.Timestamp {
	if x != nil {
...
type DeviceModulesConfig struct {
	...
	SyncRequested *timestamp.Timestamp `protobuf:"bytes,1,opt,name=sync_requested,json=syncRequested,proto3" json:"sync_requested,omitempty"`
...
func (x *DeviceModulesConfig) GetSyncRequested() *timestamp.Timestamp {
	if x != nil {
...
func (x *DeviceConnectionSettings) GetMaxOffline() *duration.Duration {
	if x != nil {
		return x.MaxOffline
	}
	return nil
...
func (x *DeviceStatus) GetUpdated() *timestamp.Timestamp {
	if x != nil {
		return x.Updated
	}
	return nil
...
func (x *DeviceModulesStatus) GetLastUpdated() *timestamp.Timestamp {
	if x != nil {
...
type DeviceBootStatus struct {
	...
	LastBoot        *timestamp.Timestamp `protobuf:"bytes,1,opt,name=last_boot,json=lastBoot,proto3" json:"last_boot,omitempty"`
	InFactory       bool                 `protobuf:"varint,2,opt,name=in_factory,json=inFactory,proto3" json:"in_factory,omitempty"`
	LastFactoryBoot *timestamp.Timestamp `protobuf:"bytes,3,opt,name=last_factory_boot,json=lastFactoryBoot,proto3" json:"last_factory_boot,omitempty"`
}
...
func (x *DeviceBootStatus) GetLastBoot() *timestamp.Timestamp {
	if x != nil {
		return x.LastBoot
	}
	return nil
...
func (x *DeviceBootStatus) GetLastFactoryBoot() *timestamp.Timestamp {
	if x != nil {
...
type HardwareToDeviceInfo struct {
	...
	Bound      *timestamp.Timestamp `protobuf:"bytes,3,opt,name=bound,proto3" json:"bound,omitempty"`
	Unbound    *timestamp.Timestamp `protobuf:"bytes,4,opt,name=unbound,proto3" json:"unbound,omitempty"`
}
...
func (x *HardwareToDeviceInfo) GetBound() *timestamp.Timestamp {
	if x != nil {
		return x.Bound
	}
	return nil
...
func (x *HardwareToDeviceInfo) GetUnbound() *timestamp.Timestamp {
	if x != nil {
		return x.Unbound
	}
	return nil
...
func (x *DeviceEvent) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *DeviceHealth_Power) GetLastUpdated() *timestamp.Timestamp {
	if x != nil {
		return x.LastUpdated
	}
	return nil
...
func (x *DeviceHealth_BatteryCurve) GetLastUpdated() *timestamp.Timestamp {
	if x != nil {
		return x.LastUpdated
	}
	return nil
...
func (x *DeviceHealth_Connectivity) GetLastSeen() *timestamp.Timestamp {
	if x != nil {
		return x.LastSeen
	}
	return nil
...
func (x *DeviceHealth_Power_Value) GetPluggedin() *empty.Empty {
...
type DeviceHealth_Power_Value_Pluggedin struct {
	Pluggedin *empty.Empty `protobuf:"bytes,2,opt,name=pluggedin,proto3,oneof"`
}
...
var file_toit_model_device_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x43, 0x65, 0x6c, 0x6c, 0x75, 0x6c, 0x61, 0x72, 0x10, 0x01, 0x42, 0x65, 0x0a, 0x18,
	...
	0x6d, 0x2f, 0x74, 0x6f, 0x69, 0x74, 0x77, 0x61, 0x72, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x67,
	0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2f, 0x74, 0x6f, 0x69, 0x74, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c,
	0xaa, 0x02, 0x10, 0x54, 0x6f, 0x69, 0x74, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4d, 0x6f,
