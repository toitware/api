...
type Publisher_Device struct {
	...
	WrittenAt  *timestamp.Timestamp `protobuf:"bytes,5,opt,name=written_at,json=writtenAt,proto3" json:"written_at,omitempty"`
}
...
func (x *Publisher_Device) GetWrittenAt() *timestamp.Timestamp {
	if x != nil {
		return x.WrittenAt
	}
	return nil
