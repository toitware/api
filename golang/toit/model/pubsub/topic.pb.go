...
type Topic struct {
	...
	Parameters *Topic_Parameters `protobuf:"bytes,3,opt,name=parameters,proto3" json:"parameters,omitempty"`
}
...
func (x *Topic) GetParameters() *Topic_Parameters {
	if x != nil {
		return x.Parameters
	}
	return nil
...
type Topic_Parameters struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DeviceId   []byte `protobuf:"bytes,1,opt,name=device_id,json=deviceId,proto3" json:"device_id,omitempty"`
	OnlyLatest bool   `protobuf:"varint,2,opt,name=only_latest,json=onlyLatest,proto3" json:"only_latest,omitempty"`
}

func (x *Topic_Parameters) Reset() {
	*x = Topic_Parameters{}
	if protoimpl.UnsafeEnabled {
		mi := &file_toit_model_pubsub_topic_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Topic_Parameters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Topic_Parameters) ProtoMessage() {}

func (x *Topic_Parameters) ProtoReflect() protoreflect.Message {
	mi := &file_toit_model_pubsub_topic_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Topic_Parameters.ProtoReflect.Descriptor instead.
func (*Topic_Parameters) Descriptor() ([]byte, []int) {
	return file_toit_model_pubsub_topic_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Topic_Parameters) GetDeviceId() []byte {
	if x != nil {
		return x.DeviceId
	}
	return nil
...
func (x *Topic_Parameters) GetOnlyLatest() bool {
	if x != nil {
		return x.OnlyLatest
	}
	return false
...
var file_toit_model_pubsub_topic_proto_rawDesc = []byte{
	...
	0x75, 0x62, 0x22, 0xde, 0x01, 0x0a, 0x05, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x12, 0x30, 0x0a, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x74, 0x6f, 0x69,
	0x74, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x70, 0x75, 0x62, 0x73, 0x75, 0x62, 0x2e, 0x54,
	0x6f, 0x70, 0x69, 0x63, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x12,
	0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x12, 0x43, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x74, 0x6f, 0x69, 0x74, 0x2e, 0x6d, 0x6f,
	...
	,
...
var file_toit_model_pubsub_topic_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_toit_model_pubsub_topic_proto_goTypes = []interface{}{
	...
	(*Topic_Parameters)(nil), // 2: toit.model.pubsub.Topic.Parameters
}
var file_toit_model_pubsub_topic_proto_depIdxs = []int32{
	...
	2, // 1: toit.model.pubsub.Topic.parameters:type_name -> toit.model.pubsub.Topic.Parameters
...
func file_toit_model_pubsub_topic_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_toit_model_pubsub_topic_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Topic_Parameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
