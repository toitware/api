...
// Deprecated: Do not use.
func (x *GuageMetricData) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *PlotMetricData) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
type LogData struct {
	...
	Tags    map[string]*_struct.Value `protobuf:"bytes,6,rep,name=tags,proto3" json:"tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *LogData) GetTags() map[string]*_struct.Value {
	if x != nil {
		return x.Tags
	}
	return nil
