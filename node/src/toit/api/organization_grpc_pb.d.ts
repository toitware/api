...
interface IOrganizationServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  claimHardwareIdentity: grpc.MethodDefinition<toit_api_organization_pb.ClaimHardwareIdentityRequest, toit_api_organization_pb.ClaimHardwareIdentityResponse>;
  setHardwareIdentityInfo: grpc.MethodDefinition<toit_api_organization_pb.SetHardwareIdentityInfoRequest, toit_api_organization_pb.SetHardwareIdentityInfoResponse>;
}
...
export class OrganizationServiceClient extends grpc.Client {
  ...
  claimHardwareIdentity(argument: toit_api_organization_pb.ClaimHardwareIdentityRequest, callback: grpc.requestCallback<toit_api_organization_pb.ClaimHardwareIdentityResponse>): grpc.ClientUnaryCall;
  claimHardwareIdentity(argument: toit_api_organization_pb.ClaimHardwareIdentityRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<toit_api_organization_pb.ClaimHardwareIdentityResponse>): grpc.ClientUnaryCall;
  claimHardwareIdentity(argument: toit_api_organization_pb.ClaimHardwareIdentityRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<toit_api_organization_pb.ClaimHardwareIdentityResponse>): grpc.ClientUnaryCall;
  setHardwareIdentityInfo(argument: toit_api_organization_pb.SetHardwareIdentityInfoRequest, callback: grpc.requestCallback<toit_api_organization_pb.SetHardwareIdentityInfoResponse>): grpc.ClientUnaryCall;
  setHardwareIdentityInfo(argument: toit_api_organization_pb.SetHardwareIdentityInfoRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<toit_api_organization_pb.SetHardwareIdentityInfoResponse>): grpc.ClientUnaryCall;
  setHardwareIdentityInfo(argument: toit_api_organization_pb.SetHardwareIdentityInfoRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<toit_api_organization_pb.SetHardwareIdentityInfoResponse>): grpc.ClientUnaryCall;
}
