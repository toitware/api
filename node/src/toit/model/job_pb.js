...
goog.exportSymbol('proto.toit.model.PubSubStatus', null, global);
 ...
 * @constructor
 */
proto.toit.model.PubSubStatus = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.toit.model.PubSubStatus, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.toit.model.PubSubStatus.displayName = 'proto.toit.model.PubSubStatus';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.toit.model.PubSubStatus.prototype.toObject = function(opt_includeInstance) {
  return proto.toit.model.PubSubStatus.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.toit.model.PubSubStatus} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.toit.model.PubSubStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    jobId: msg.getJobId_asB64(),
    subscriptionId: msg.getSubscriptionId_asB64(),
 ...
 */
proto.toit.model.PubSubStatus.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.toit.model.PubSubStatus;
  return proto.toit.model.PubSubStatus.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.toit.model.PubSubStatus} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.toit.model.PubSubStatus}
 */
proto.toit.model.PubSubStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 3:
      ...
      msg.setLastMessageReceivedId(value);
      break;
    case 4:
      var value = new google_protobuf_timestamp_pb.Timestamp;
      reader.readMessage(value,google_protobuf_timestamp_pb.Timestamp.deserializeBinaryFromReader);
      msg.setLastMessageReceivedCreatedAt(value);
      break;
    case 5:
      var value = /** @type {number} */ (reader.readUint64());
      msg.setUnacknowledgedMessages(value);
      break;
    case 6:
      var value = new google_protobuf_timestamp_pb.Timestamp;
      reader.readMessage(value,google_protobuf_timestamp_pb.Timestamp.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.toit.model.PubSubStatus.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.toit.model.PubSubStatus.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.toit.model.PubSubStatus} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.toit.model.PubSubStatus.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getJobId_asU8();
  if (f.length > 0) {
    writer.writeBytes(
  ...
  f = message.getSubscriptionId_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      2,
      f
  ...
  f = message.getLastMessageReceivedId();
  if (f !== 0) {
    writer.writeUint64(
      3,
      f
  ...
  f = message.getLastMessageReceivedCreatedAt();
  if (f != null) {
    writer.writeMessage(
      4,
      f,
  ...
  f = message.getUnacknowledgedMessages();
  if (f !== 0) {
    writer.writeUint64(
      5,
      f
  ...
  f = message.getLatestMessageInTopicCreatedAt();
  if (f != null) {
    writer.writeMessage(
      6,
      f,
 ...
 * @return {!(string|Uint8Array)}
 */
proto.toit.model.PubSubStatus.prototype.getJobId = function() {
 ...
 * @return {string}
 */
proto.toit.model.PubSubStatus.prototype.getJobId_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getJobId()));
};
 ...
 * @return {!Uint8Array}
 */
proto.toit.model.PubSubStatus.prototype.getJobId_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getJobId()));
};
 ...
 */
proto.toit.model.PubSubStatus.prototype.setJobId = function(value) {
 ...
 * @return {!(string|Uint8Array)}
 */
proto.toit.model.PubSubStatus.prototype.getSubscriptionId = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
...
/**
 * optional bytes subscription_id = 2;
 * This is a type-conversion wrapper around `getSubscriptionId()`
 * @return {string}
 */
proto.toit.model.PubSubStatus.prototype.getSubscriptionId_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
 ...
 * @return {!Uint8Array}
 */
proto.toit.model.PubSubStatus.prototype.getSubscriptionId_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getSubscriptionId()));
};
 ...
 * @return {!proto.toit.model.PubSubStatus} returns this
 */
proto.toit.model.PubSubStatus.prototype.setSubscriptionId = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};


/**
 * optional uint64 last_message_received_id = 3;
 * @return {number}
 */
proto.toit.model.PubSubStatus.prototype.getLastMessageReceivedId = function() {
 ...
 * @return {!proto.toit.model.PubSubStatus} returns this
 */
proto.toit.model.PubSubStatus.prototype.setLastMessageReceivedId = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};


/**
 * optional google.protobuf.Timestamp last_message_received_created_at = 4;
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.toit.model.PubSubStatus.prototype.getLastMessageReceivedCreatedAt = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
 ...
 * @return {!proto.toit.model.PubSubStatus} returns this
*/
proto.toit.model.PubSubStatus.prototype.setLastMessageReceivedCreatedAt = function(value) {
  return jspb.Message.setWrapperField(this, 4, value);
};
 ...
 * @return {!proto.toit.model.PubSubStatus} returns this
 */
proto.toit.model.PubSubStatus.prototype.clearLastMessageReceivedCreatedAt = function() {
  return this.setLastMessageReceivedCreatedAt(undefined);
};
 ...
 * @return {boolean}
 */
proto.toit.model.PubSubStatus.prototype.hasLastMessageReceivedCreatedAt = function() {
  return jspb.Message.getField(this, 4) != null;
};


/**
 * optional uint64 unacknowledged_messages = 5;
 * @return {number}
 */
proto.toit.model.PubSubStatus.prototype.getUnacknowledgedMessages = function() {
 ...
 * @return {!proto.toit.model.PubSubStatus} returns this
 */
proto.toit.model.PubSubStatus.prototype.setUnacknowledgedMessages = function(value) {
  return jspb.Message.setProto3IntField(this, 5, value);
};


/**
 * optional google.protobuf.Timestamp latest_message_in_topic_created_at = 6;
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.toit.model.PubSubStatus.prototype.getLatestMessageInTopicCreatedAt = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
    jspb.Message.getWrapperField(this, google_protobuf_timestamp_pb.Timestamp, 6));
};
 ...
 * @return {!proto.toit.model.PubSubStatus} returns this
*/
proto.toit.model.PubSubStatus.prototype.setLatestMessageInTopicCreatedAt = function(value) {
  return jspb.Message.setWrapperField(this, 6, value);
};
 ...
 * @return {!proto.toit.model.PubSubStatus} returns this
 */
proto.toit.model.PubSubStatus.prototype.clearLatestMessageInTopicCreatedAt = function() {
  return this.setLatestMessageInTopicCreatedAt(undefined);
};
