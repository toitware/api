...
class Source extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Source', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model'), createEmptyInstance: create)
...
class Program extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Program', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id', $pb.PbFieldType.OY)
  ...
  @$pb.TagNumber(6)
  set source(Source v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set organizationId($core.List<$core.int> v) { $_setBytes(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set creatorId($core.List<$core.int> v) { $_setBytes(7, v); }
  @$pb.TagNumber(8)
...
class Compilation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Compilation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id', $pb.PbFieldType.OY)
  ...
  factory Compilation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Compilation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Compilation copyWith(void Function(Compilation) updates) => super.copyWith((message) => updates(message as Compilation)) as Compilation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Compilation getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Compilation>(create);
  ...
  @$pb.TagNumber(4)
  set programId($core.List<$core.int> v) { $_setBytes(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set result(CompilationResult v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(9)
  set creatorId($core.List<$core.int> v) { $_setBytes(8, v); }
  @$pb.TagNumber(9)
...
class CompilationResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CompilationResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error')
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'snapshotOut', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'snapshotErr', $pb.PbFieldType.OY)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CompilationResult copyWith(void Function(CompilationResult) updates) => super.copyWith((message) => updates(message as CompilationResult)) as CompilationResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set snapshotOut($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set snapshotErr($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set snapshotExitcode($core.int v) { $_setSignedInt32(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set imageOut($core.List<$core.int> v) { $_setBytes(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set imageErr($core.List<$core.int> v) { $_setBytes(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set imageExitcode($core.int v) { $_setSignedInt32(6, v); }
  @$pb.TagNumber(7)
...
class SDK extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SDK', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'settings', entryClassName: 'SDK.SettingsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('toit.model'))
  ...
  @$pb.TagNumber(7)
  set releaseLevel(ReleaseLevel_Type v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class ReleaseLevel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReleaseLevel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  ReleaseLevel._() : super();
  factory ReleaseLevel() => create();
  factory ReleaseLevel.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ReleaseLevel.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReleaseLevel copyWith(void Function(ReleaseLevel) updates) => super.copyWith((message) => updates(message as ReleaseLevel)) as ReleaseLevel; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ReleaseLevel create() => ReleaseLevel._();
  ReleaseLevel createEmptyInstance() => create();
  static $pb.PbList<ReleaseLevel> createRepeated() => $pb.PbList<ReleaseLevel>();
  @$core.pragma('dart2js:noInline')
  static ReleaseLevel getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ReleaseLevel>(create);
