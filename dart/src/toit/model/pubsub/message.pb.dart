...
class Envelope extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Envelope', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model.pubsub'), createEmptyInstance: create)
...
class Publisher_External extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Publisher.External', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model.pubsub'), createEmptyInstance: create)
  ...
  factory Publisher_External.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Publisher_External.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Publisher_External copyWith(void Function(Publisher_External) updates) => super.copyWith((message) => updates(message as Publisher_External)) as Publisher_External; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Publisher_External create() => Publisher_External._();
  Publisher_External createEmptyInstance() => create();
  static $pb.PbList<Publisher_External> createRepeated() => $pb.PbList<Publisher_External>();
  @$core.pragma('dart2js:noInline')
  static Publisher_External getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Publisher_External>(create);
...
class Publisher_Device extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Publisher.Device', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model.pubsub'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventId', $pb.PbFieldType.OY)
  ...
  factory Publisher_Device.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Publisher_Device.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Publisher_Device copyWith(void Function(Publisher_Device) updates) => super.copyWith((message) => updates(message as Publisher_Device)) as Publisher_Device; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Publisher_Device create() => Publisher_Device._();
  Publisher_Device createEmptyInstance() => create();
  static $pb.PbList<Publisher_Device> createRepeated() => $pb.PbList<Publisher_Device>();
  @$core.pragma('dart2js:noInline')
  static Publisher_Device getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Publisher_Device>(create);
  ...
  @$pb.TagNumber(3)
  set eventId($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set writtenAt($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class Publisher extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Publisher_Publisher> _Publisher_PublisherByTag = {
    1 : Publisher_Publisher.device,
    2 : Publisher_Publisher.external,
    0 : Publisher_Publisher.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Publisher', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model.pubsub'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<Publisher_Device>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'device', subBuilder: Publisher_Device.create)
    ..aOM<Publisher_External>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'external', subBuilder: Publisher_External.create)
    ..hasRequiredFields = false
  ;
  ...
  Publisher_Publisher whichPublisher() => _Publisher_PublisherByTag[$_whichOneof(0)]!;
  void clearPublisher() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  Publisher_Device get device => $_getN(0);
  @$pb.TagNumber(1)
  set device(Publisher_Device v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set external(Publisher_External v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Message extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Message', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.model.pubsub'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'topic')
    ..aOM<Publisher>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publisher', subBuilder: Publisher.create)
  ...
  @$pb.TagNumber(2)
  set publisher(Publisher v) { setField(2, v); }
  @$pb.TagNumber(2)
