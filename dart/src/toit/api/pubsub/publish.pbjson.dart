...
const PublishRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'publisher_name', '3': 2, '4': 1, '5': 9, '10': 'publisherName'},
    const {'1': 'data', '3': 3, '4': 3, '5': 12, '10': 'data'},
  ],
};

/// Descriptor for `PublishRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List publishRequestDescriptor = $convert.base64Decode('Cg5QdWJsaXNoUmVxdWVzdBIUCgV0b3BpYxgBIAEoCVIFdG9waWMSJQoOcHVibGlzaGVyX25hbWUYAiABKAlSDXB1Ymxpc2hlck5hbWUSEgoEZGF0YRgDIAMoDFIEZGF0YQ==');
