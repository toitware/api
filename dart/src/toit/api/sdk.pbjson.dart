...
final $typed_data.Uint8List registerSDKRequestDescriptor = $convert.base64Decode('ChJSZWdpc3RlclNES1JlcXVlc3QSEAoDc2RrGAEgASgMUgNzZGsSIQoMa2VlcF9kZWZhdWx0GAIgASgIUgtrZWVwRGVmYXVsdA==');
...
final $typed_data.Uint8List registerSDKResponseDescriptor = $convert.base64Decode('ChNSZWdpc3RlclNES1Jlc3BvbnNlEhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List deregisterSDKRequestDescriptor = $convert.base64Decode('ChREZXJlZ2lzdGVyU0RLUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEiEKDGNoZWNrX2V4aXN0cxgCIAEoCFILY2hlY2tFeGlzdHM=');
...
final $typed_data.Uint8List deregisterSDKResponseDescriptor = $convert.base64Decode('ChVEZXJlZ2lzdGVyU0RLUmVzcG9uc2U=');
...
final $typed_data.Uint8List lookupSDKRequestDescriptor = $convert.base64Decode('ChBMb29rdXBTREtSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
const LookupSDKResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sdk', '3': 7, '4': 1, '5': 11, '6': '.toit.model.SDK', '10': 'sdk'},
  ],
...
final $typed_data.Uint8List lookupSDKResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List defaultSDKRequestDescriptor = $convert.base64Decode('ChFEZWZhdWx0U0RLUmVxdWVzdA==');
...
final $typed_data.Uint8List defaultSDKResponseDescriptor = $convert.base64Decode('ChJEZWZhdWx0U0RLUmVzcG9uc2USEgoEbmFtZRgBIAEoCVIEbmFtZQ==');
...
final $typed_data.Uint8List listSDKsRequestDescriptor = $convert.base64Decode('Cg9MaXN0U0RLc1JlcXVlc3Q=');
@$core.Deprecated('Use listSDKsResponseDescriptor instead')
const ListSDKsResponse$json = const {
  '1': 'ListSDKsResponse',
  '2': const [
    const {'1': 'sdks', '3': 1, '4': 3, '5': 11, '6': '.toit.model.SDK', '10': 'sdks'},
  ],
};

/// Descriptor for `ListSDKsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listSDKsResponseDescriptor = $convert.base64Decode('ChBMaXN0U0RLc1Jlc3BvbnNlEiMKBHNka3MYASADKAsyDy50b2l0Lm1vZGVsLlNES1IEc2Rrcw==');
...
final $typed_data.Uint8List validateModelRequestDescriptor = $convert.base64Decode('ChRWYWxpZGF0ZU1vZGVsUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEhQKBW1vZGVsGAIgASgJUgVtb2RlbA==');
...
final $typed_data.Uint8List validateModelResponseDescriptor = $convert.base64Decode('ChVWYWxpZGF0ZU1vZGVsUmVzcG9uc2U=');
...
final $typed_data.Uint8List setDefaultSDKRequestDescriptor = $convert.base64Decode('ChRTZXREZWZhdWx0U0RLUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');
...
final $typed_data.Uint8List setDefaultSDKResponseDescriptor = $convert.base64Decode('ChVTZXREZWZhdWx0U0RLUmVzcG9uc2U=');
...
final $typed_data.Uint8List getFirmwareElfRequestDescriptor = $convert.base64Decode('ChVHZXRGaXJtd2FyZUVsZlJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRIUCgVtb2RlbBgCIAEoCVIFbW9kZWw=');
...
final $typed_data.Uint8List getFirmwareElfResponseDescriptor = $convert.base64Decode('ChZHZXRGaXJtd2FyZUVsZlJlc3BvbnNlEhoKCGNoZWNrc3VtGAEgASgMUghjaGVja3N1bRISCgRmaWxlGAIgASgMUgRmaWxl');
