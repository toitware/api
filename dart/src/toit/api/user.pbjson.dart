...
final $typed_data.Uint8List setPasswordRequestDescriptor = $convert.base64Decode('ChJTZXRQYXNzd29yZFJlcXVlc3QSIQoMb2xkX3Bhc3N3b3JkGAEgASgJUgtvbGRQYXNzd29yZBIhCgxuZXdfcGFzc3dvcmQYAiABKAlSC25ld1Bhc3N3b3Jk');
...
final $typed_data.Uint8List setPasswordResponseDescriptor = $convert.base64Decode('ChNTZXRQYXNzd29yZFJlc3BvbnNl');
...
final $typed_data.Uint8List initiateResetPasswordRequestDescriptor = $convert.base64Decode('ChxJbml0aWF0ZVJlc2V0UGFzc3dvcmRSZXF1ZXN0EhQKBWVtYWlsGAEgASgJUgVlbWFpbA==');
...
final $typed_data.Uint8List initiateResetPasswordResponseDescriptor = $convert.base64Decode('Ch1Jbml0aWF0ZVJlc2V0UGFzc3dvcmRSZXNwb25zZQ==');
...
final $typed_data.Uint8List changePasswordWithRPTokenRequestDescriptor = $convert.base64Decode('CiBDaGFuZ2VQYXNzd29yZFdpdGhSUFRva2VuUmVxdWVzdBIUCgV0b2tlbhgBIAEoCVIFdG9rZW4SIQoMbmV3X3Bhc3N3b3JkGAIgASgJUgtuZXdQYXNzd29yZA==');
...
final $typed_data.Uint8List changePasswordWithRPTokenResponseDescriptor = $convert.base64Decode('CiFDaGFuZ2VQYXNzd29yZFdpdGhSUFRva2VuUmVzcG9uc2U=');
...
const GetCurrentUserResponse$json = const {
  ...
  '2': const [
    const {'1': 'user', '3': 1, '4': 1, '5': 11, '6': '.toit.model.User', '10': 'user'},
    const {'1': 'organization', '3': 2, '4': 1, '5': 11, '6': '.toit.model.Organization', '10': 'organization'},
  ],
};

/// Descriptor for `GetCurrentUserResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getCurrentUserResponseDescriptor = $convert.base64Decode('ChZHZXRDdXJyZW50VXNlclJlc3BvbnNlEiQKBHVzZXIYASABKAsyEC50b2l0Lm1vZGVsLlVzZXJSBHVzZXISPAoMb3JnYW5pemF0aW9uGAIgASgLMhgudG9pdC5tb2RlbC5Pcmdhbml6YXRpb25SDG9yZ2FuaXphdGlvbg==');
...
final $typed_data.Uint8List listOrganizationsRequestDescriptor = $convert.base64Decode('ChhMaXN0T3JnYW5pemF0aW9uc1JlcXVlc3QSFwoHdXNlcl9pZBgBIAEoDFIGdXNlcklkEhYKBm9mZnNldBgCIAEoDFIGb2Zmc2V0EhQKBWxpbWl0GAMgASgDUgVsaW1pdBIZCghvcmRlcl9ieRgEIAEoCVIHb3JkZXJCeRIdCgpvcmRlcl9kZXNjGAUgASgIUglvcmRlckRlc2M=');
...
const ListOrganizationsResponse$json = const {
  ...
  '2': const [
    const {'1': 'organizations', '3': 1, '4': 3, '5': 11, '6': '.toit.model.Organization', '10': 'organizations'},
    const {'1': 'offset', '3': 2, '4': 1, '5': 12, '10': 'offset'},
  ],
};

/// Descriptor for `ListOrganizationsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listOrganizationsResponseDescriptor = $convert.base64Decode('ChlMaXN0T3JnYW5pemF0aW9uc1Jlc3BvbnNlEj4KDW9yZ2FuaXphdGlvbnMYASADKAsyGC50b2l0Lm1vZGVsLk9yZ2FuaXphdGlvblINb3JnYW5pemF0aW9ucxIWCgZvZmZzZXQYAiABKAxSBm9mZnNldA==');
...
final $typed_data.Uint8List getOrganizationRequestDescriptor = $convert.base64Decode('ChZHZXRPcmdhbml6YXRpb25SZXF1ZXN0Eg4KAmlkGAEgASgMUgJpZA==');
...
const GetOrganizationResponse$json = const {
  ...
  '2': const [
    const {'1': 'organization', '3': 1, '4': 1, '5': 11, '6': '.toit.model.Organization', '10': 'organization'},
  ],
};

/// Descriptor for `GetOrganizationResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getOrganizationResponseDescriptor = $convert.base64Decode('ChdHZXRPcmdhbml6YXRpb25SZXNwb25zZRI8Cgxvcmdhbml6YXRpb24YASABKAsyGC50b2l0Lm1vZGVsLk9yZ2FuaXphdGlvblIMb3JnYW5pemF0aW9u');
...
const CreatePaymentSubscriptionRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'card_expiry_month', '3': 4, '4': 1, '5': 5, '10': 'cardExpiryMonth'},
    const {'1': 'card_expiry_year', '3': 5, '4': 1, '5': 5, '10': 'cardExpiryYear'},
...
final $typed_data.Uint8List createPaymentSubscriptionRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List createPaymentSubscriptionResponseDescriptor = $convert.base64Decode('CiFDcmVhdGVQYXltZW50U3Vic2NyaXB0aW9uUmVzcG9uc2U=');
...
final $typed_data.Uint8List listPaymentInvoicesRequestDescriptor = $convert.base64Decode('ChpMaXN0UGF5bWVudEludm9pY2VzUmVxdWVzdBIUCgVsaW1pdBgBIAEoA1IFbGltaXQSFgoGb2Zmc2V0GAIgASgMUgZvZmZzZXQ=');
...
const ListPaymentInvoicesResponse$json = const {
  ...
  '2': const [
    const {'1': 'invoices', '3': 1, '4': 1, '5': 11, '6': '.toit.api.Invoice', '10': 'invoices'},
  ],
};

/// Descriptor for `ListPaymentInvoicesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listPaymentInvoicesResponseDescriptor = $convert.base64Decode('ChtMaXN0UGF5bWVudEludm9pY2VzUmVzcG9uc2USLQoIaW52b2ljZXMYASABKAsyES50b2l0LmFwaS5JbnZvaWNlUghpbnZvaWNlcw==');
@$core.Deprecated('Use invoiceDescriptor instead')
const Invoice$json = const {
  '1': 'Invoice',
  '2': const [
    const {'1': 'invoice_id', '3': 1, '4': 1, '5': 9, '10': 'invoiceId'},
    const {'1': 'invoice_number', '3': 2, '4': 1, '5': 9, '10': 'invoiceNumber'},
    ...
    const {'1': 'receipt_pdf_url', '3': 7, '4': 1, '5': 9, '10': 'receiptPdfUrl'},
    const {'1': 'amount_paid', '3': 8, '4': 1, '5': 3, '10': 'amountPaid'},
  ],
};

/// Descriptor for `Invoice`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List invoiceDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List cancelPaymentSubscriptionRequestDescriptor = $convert.base64Decode('CiBDYW5jZWxQYXltZW50U3Vic2NyaXB0aW9uUmVxdWVzdA==');
...
final $typed_data.Uint8List cancelPaymentSubscriptionResponseDescriptor = $convert.base64Decode('CiFDYW5jZWxQYXltZW50U3Vic2NyaXB0aW9uUmVzcG9uc2U=');
@$core.Deprecated('Use userChangeDescriptor instead')
const UserChange$json = const {
  '1': 'UserChange',
  '2': const [
    const {'1': 'set_settings_welcome_closed', '3': 1, '4': 1, '5': 8, '9': 0, '10': 'setSettingsWelcomeClosed'},
    const {'1': 'set_settings_newsletter', '3': 2, '4': 1, '5': 8, '9': 0, '10': 'setSettingsNewsletter'},
  ],
  '8': const [
    const {'1': 'change'},
  ],
...
final $typed_data.Uint8List userChangeDescriptor = $convert.base64Decode('CgpVc2VyQ2hhbmdlEj8KG3NldF9zZXR0aW5nc193ZWxjb21lX2Nsb3NlZBgBIAEoCEgAUhhzZXRTZXR0aW5nc1dlbGNvbWVDbG9zZWQSOAoXc2V0X3NldHRpbmdzX25ld3NsZXR0ZXIYAiABKAhIAFIVc2V0U2V0dGluZ3NOZXdzbGV0dGVyQggKBmNoYW5nZQ==');
@$core.Deprecated('Use updateUserRequestDescriptor instead')
const UpdateUserRequest$json = const {
  '1': 'UpdateUserRequest',
  '2': const [
    const {'1': 'changes', '3': 1, '4': 3, '5': 11, '6': '.toit.api.UserChange', '10': 'changes'},
  ],
};

/// Descriptor for `UpdateUserRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateUserRequestDescriptor = $convert.base64Decode('ChFVcGRhdGVVc2VyUmVxdWVzdBIuCgdjaGFuZ2VzGAEgAygLMhQudG9pdC5hcGkuVXNlckNoYW5nZVIHY2hhbmdlcw==');
