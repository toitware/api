...
const CreateSimulatorRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'identity', '3': 2, '4': 1, '5': 11, '6': '.toit.model.HardwareIdentity', '10': 'identity'},
...
final $typed_data.Uint8List createSimulatorRequestDescriptor = $convert.base64Decode('ChZDcmVhdGVTaW11bGF0b3JSZXF1ZXN0EhkKCHNka19uYW1lGAEgASgJUgdzZGtOYW1lEjgKCGlkZW50aXR5GAIgASgLMhwudG9pdC5tb2RlbC5IYXJkd2FyZUlkZW50aXR5UghpZGVudGl0eRIfCgtkZXZpY2VfbmFtZRgDIAEoCVIKZGV2aWNlTmFtZQ==');
...
final $typed_data.Uint8List createSimulatorResponseDescriptor = $convert.base64Decode('ChdDcmVhdGVTaW11bGF0b3JSZXNwb25zZRIhCgxzaW11bGF0b3JfaWQYASABKAxSC3NpbXVsYXRvcklkEh8KC2hhcmR3YXJlX2lkGAIgASgMUgpoYXJkd2FyZUlkEhsKCWRldmljZV9pZBgDIAEoDFIIZGV2aWNlSWQSHwoLZGV2aWNlX25hbWUYBCABKAlSCmRldmljZU5hbWU=');
...
final $typed_data.Uint8List removeSimulatorRequestDescriptor = $convert.base64Decode('ChZSZW1vdmVTaW11bGF0b3JSZXF1ZXN0EiEKDHNpbXVsYXRvcl9pZBgBIAEoDFILc2ltdWxhdG9ySWQSGwoJZGV2aWNlX2lkGAMgASgMUghkZXZpY2VJZA==');
...
final $typed_data.Uint8List removeSimulatorResponseDescriptor = $convert.base64Decode('ChdSZW1vdmVTaW11bGF0b3JSZXNwb25zZQ==');
...
final $typed_data.Uint8List listSimulatorsRequestDescriptor = $convert.base64Decode('ChVMaXN0U2ltdWxhdG9yc1JlcXVlc3Q=');
...
final $typed_data.Uint8List listSimulatorsResponseDescriptor = $convert.base64Decode('ChZMaXN0U2ltdWxhdG9yc1Jlc3BvbnNlEiMKDXNpbXVsYXRvcl9pZHMYASADKAxSDHNpbXVsYXRvcklkcw==');
...
final $typed_data.Uint8List createHardwareIdentityRequestDescriptor = $convert.base64Decode('Ch1DcmVhdGVIYXJkd2FyZUlkZW50aXR5UmVxdWVzdA==');
...
const CreateHardwareIdentityResponse$json = const {
  ...
  '2': const [
    const {'1': 'identity', '3': 1, '4': 1, '5': 11, '6': '.toit.model.HardwareIdentity', '10': 'identity'},
  ],
};

/// Descriptor for `CreateHardwareIdentityResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createHardwareIdentityResponseDescriptor = $convert.base64Decode('Ch5DcmVhdGVIYXJkd2FyZUlkZW50aXR5UmVzcG9uc2USOAoIaWRlbnRpdHkYASABKAsyHC50b2l0Lm1vZGVsLkhhcmR3YXJlSWRlbnRpdHlSCGlkZW50aXR5');
