...
final $typed_data.Uint8List listUsersRequestDescriptor = $convert.base64Decode('ChBMaXN0VXNlcnNSZXF1ZXN0EhYKBm9mZnNldBgBIAEoDFIGb2Zmc2V0EhQKBWxpbWl0GAIgASgDUgVsaW1pdBIZCghvcmRlcl9ieRgDIAEoCVIHb3JkZXJCeRIdCgpvcmRlcl9kZXNjGAQgASgIUglvcmRlckRlc2M=');
@$core.Deprecated('Use listUsersResponseDescriptor instead')
const ListUsersResponse$json = const {
  '1': 'ListUsersResponse',
  '2': const [
    const {'1': 'users', '3': 1, '4': 3, '5': 11, '6': '.toit.model.User', '10': 'users'},
    const {'1': 'offset', '3': 2, '4': 1, '5': 12, '10': 'offset'},
  ],
};

/// Descriptor for `ListUsersResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listUsersResponseDescriptor = $convert.base64Decode('ChFMaXN0VXNlcnNSZXNwb25zZRImCgV1c2VycxgBIAMoCzIQLnRvaXQubW9kZWwuVXNlclIFdXNlcnMSFgoGb2Zmc2V0GAIgASgMUgZvZmZzZXQ=');
...
final $typed_data.Uint8List createUserResponseDescriptor = $convert.base64Decode('ChJDcmVhdGVVc2VyUmVzcG9uc2USJAoEdXNlchgBIAEoCzIQLnRvaXQubW9kZWwuVXNlclIEdXNlcg==');
...
final $typed_data.Uint8List getUserRequestDescriptor = $convert.base64Decode('Cg5HZXRVc2VyUmVxdWVzdBIOCgJpZBgBIAEoDFICaWQSFAoFZW1haWwYAiABKAlSBWVtYWls');
...
final $typed_data.Uint8List getUserResponseDescriptor = $convert.base64Decode('Cg9HZXRVc2VyUmVzcG9uc2USJAoEdXNlchgBIAEoCzIQLnRvaXQubW9kZWwuVXNlclIEdXNlcg==');
...
final $typed_data.Uint8List createAPIKeyRequestDescriptor = $convert.base64Decode('ChNDcmVhdGVBUElLZXlSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
@$core.Deprecated('Use createAPIKeyResponseDescriptor instead')
const CreateAPIKeyResponse$json = const {
  '1': 'CreateAPIKeyResponse',
  '2': const [
    const {'1': 'api_key', '3': 1, '4': 1, '5': 11, '6': '.toit.model.APIKey', '10': 'apiKey'},
  ],
};

/// Descriptor for `CreateAPIKeyResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createAPIKeyResponseDescriptor = $convert.base64Decode('ChRDcmVhdGVBUElLZXlSZXNwb25zZRIrCgdhcGlfa2V5GAEgASgLMhIudG9pdC5tb2RlbC5BUElLZXlSBmFwaUtleQ==');
...
final $typed_data.Uint8List listAPIKeysRequestDescriptor = $convert.base64Decode('ChJMaXN0QVBJS2V5c1JlcXVlc3QSFgoGb2Zmc2V0GAEgASgMUgZvZmZzZXQSFAoFbGltaXQYAiABKANSBWxpbWl0EhkKCG9yZGVyX2J5GAMgASgJUgdvcmRlckJ5Eh0KCm9yZGVyX2Rlc2MYBCABKAhSCW9yZGVyRGVzYw==');
...
final $typed_data.Uint8List listAPIKeysResponseDescriptor = $convert.base64Decode('ChNMaXN0QVBJS2V5c1Jlc3BvbnNlEisKB2FwaV9rZXkYASABKAsyEi50b2l0Lm1vZGVsLkFQSUtleVIGYXBpS2V5EhYKBm9mZnNldBgCIAEoDFIGb2Zmc2V0');
...
final $typed_data.Uint8List deleteAPIKeyRequestDescriptor = $convert.base64Decode('ChNEZWxldGVBUElLZXlSZXF1ZXN0Eg4KAmlkGAEgASgMUgJpZA==');
...
final $typed_data.Uint8List deleteAPIKeyResponseDescriptor = $convert.base64Decode('ChREZWxldGVBUElLZXlSZXNwb25zZQ==');
...
final $typed_data.Uint8List getAPIKeySecretRequestDescriptor = $convert.base64Decode('ChZHZXRBUElLZXlTZWNyZXRSZXF1ZXN0Eg4KAmlkGAEgASgMUgJpZA==');
...
final $typed_data.Uint8List getAPIKeySecretResponseDescriptor = $convert.base64Decode('ChdHZXRBUElLZXlTZWNyZXRSZXNwb25zZRIWCgZzZWNyZXQYASABKAlSBnNlY3JldA==');
...
const OrganizationChange$json = const {
  ...
  '2': const [
    ...
    const {'1': 'phone_number', '3': 3, '4': 1, '5': 9, '9': 0, '10': 'phoneNumber'},
    const {'1': 'cvr_number', '3': 4, '4': 1, '5': 9, '9': 0, '10': 'cvrNumber'},
    const {'1': 'name', '3': 5, '4': 1, '5': 9, '9': 0, '10': 'name'},
    const {'1': 'email', '3': 6, '4': 1, '5': 9, '9': 0, '10': 'email'},
    const {'1': 'vat_number', '3': 7, '4': 1, '5': 9, '9': 0, '10': 'vatNumber'},
    const {'1': 'vat_country_code', '3': 8, '4': 1, '5': 9, '9': 0, '10': 'vatCountryCode'},
    const {'1': 'address_line', '3': 9, '4': 1, '5': 9, '9': 0, '10': 'addressLine'},
    const {'1': 'postal_code', '3': 10, '4': 1, '5': 9, '9': 0, '10': 'postalCode'},
    const {'1': 'customer', '3': 11, '4': 1, '5': 14, '6': '.toit.model.Customer.Type', '9': 0, '10': 'customer'},
  ],
  '8': const [
    const {'1': 'change'},
  ],
...
final $typed_data.Uint8List organizationChangeDescriptor = $convert.base64Decode('');
...
const UpdateOrganizationRequest$json = const {
  ...
  '2': const [
    const {'1': 'changes', '3': 1, '4': 3, '5': 11, '6': '.toit.api.OrganizationChange', '10': 'changes'},
  ],
};

/// Descriptor for `UpdateOrganizationRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateOrganizationRequestDescriptor = $convert.base64Decode('ChlVcGRhdGVPcmdhbml6YXRpb25SZXF1ZXN0EjYKB2NoYW5nZXMYASADKAsyHC50b2l0LmFwaS5Pcmdhbml6YXRpb25DaGFuZ2VSB2NoYW5nZXM=');
...
final $typed_data.Uint8List createNewOrganizationRequestDescriptor = $convert.base64Decode('ChxDcmVhdGVOZXdPcmdhbml6YXRpb25SZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSFAoFZW1haWwYAiABKAlSBWVtYWls');
...
final $typed_data.Uint8List createNewOrganizationResponseDescriptor = $convert.base64Decode('Ch1DcmVhdGVOZXdPcmdhbml6YXRpb25SZXNwb25zZRInCg9vcmdhbml6YXRpb25faWQYASABKAxSDm9yZ2FuaXphdGlvbklk');
