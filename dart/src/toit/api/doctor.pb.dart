...
class HealthRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HealthRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.api'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  HealthRequest copyWith(void Function(HealthRequest) updates) => super.copyWith((message) => updates(message as HealthRequest)) as HealthRequest; // ignore: deprecated_member_use
...
class HealthResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HealthResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'toit.api'), createEmptyInstance: create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'beaver')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'grass')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'oak')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set beaver($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set grass($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set oak($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(4)
