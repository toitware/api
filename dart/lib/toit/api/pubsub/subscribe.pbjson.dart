...
final $typed_data.Uint8List subscriptionDescriptor = $convert.base64Decode(
    'CgxTdWJzY3JpcHRpb24SFAoFdG9waWMYASABKAlSBXRvcGljEhIKBG5hbWUYAiABKAlSBG5hbWU=');
...
const CreateSubscriptionRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.toit.api.pubsub.Subscription',
      '10': 'subscription'
    },
  ],
};
...
final $typed_data.Uint8List createSubscriptionRequestDescriptor =
    $convert.base64Decode(
        'ChlDcmVhdGVTdWJzY3JpcHRpb25SZXF1ZXN0EkEKDHN1YnNjcmlwdGlvbhgBIAEoCzIdLnRvaXQuYXBpLnB1YnN1Yi5TdWJzY3JpcHRpb25SDHN1YnNjcmlwdGlvbg==');
...
final $typed_data.Uint8List deleteSubscriptionRequestDescriptor =
    $convert.base64Decode(
        'ChlEZWxldGVTdWJzY3JpcHRpb25SZXF1ZXN0EkEKDHN1YnNjcmlwdGlvbhgBIAEoCzIdLnRvaXQuYXBpLnB1YnN1Yi5TdWJzY3JpcHRpb25SDHN1YnNjcmlwdGlvbg==');
...
final $typed_data.Uint8List listSubscriptionsRequestDescriptor =
    $convert.base64Decode(
        'ChhMaXN0U3Vic2NyaXB0aW9uc1JlcXVlc3QSFAoFdG9waWMYASABKAlSBXRvcGljEhYKBm9mZnNldBgDIAEoDFIGb2Zmc2V0');
...
final $typed_data.Uint8List listSubscriptionsResponseDescriptor =
    $convert.base64Decode(
        'ChlMaXN0U3Vic2NyaXB0aW9uc1Jlc3BvbnNlEkMKDXN1YnNjcmlwdGlvbnMYASADKAsyHS50b2l0LmFwaS5wdWJzdWIuU3Vic2NyaXB0aW9uUg1zdWJzY3JpcHRpb25zEh8KC25leHRfb2Zmc2V0GAIgASgMUgpuZXh0T2Zmc2V0');
...
final $typed_data.Uint8List fetchRequestDescriptor = $convert.base64Decode(
    'CgxGZXRjaFJlcXVlc3QSQQoMc3Vic2NyaXB0aW9uGAEgASgLMh0udG9pdC5hcGkucHVic3ViLlN1YnNjcmlwdGlvblIMc3Vic2NyaXB0aW9uEhQKBWxpbWl0GAIgASgFUgVsaW1pdA==');
...
final $typed_data.Uint8List fetchResponseDescriptor = $convert.base64Decode(
    'Cg1GZXRjaFJlc3BvbnNlEjcKCG1lc3NhZ2VzGAEgAygLMhsudG9pdC5tb2RlbC5wdWJzdWIuRW52ZWxvcGVSCG1lc3NhZ2Vz');
...
final $typed_data.Uint8List streamRequestDescriptor = $convert.base64Decode(
    'Cg1TdHJlYW1SZXF1ZXN0EkEKDHN1YnNjcmlwdGlvbhgBIAEoCzIdLnRvaXQuYXBpLnB1YnN1Yi5TdWJzY3JpcHRpb25SDHN1YnNjcmlwdGlvbg==');
...
final $typed_data.Uint8List streamResponseDescriptor = $convert.base64Decode(
    'Cg5TdHJlYW1SZXNwb25zZRI3CghtZXNzYWdlcxgBIAMoCzIbLnRvaXQubW9kZWwucHVic3ViLkVudmVsb3BlUghtZXNzYWdlcw==');
...
final $typed_data.Uint8List acknowledgeRequestDescriptor = $convert.base64Decode(
    'ChJBY2tub3dsZWRnZVJlcXVlc3QSQQoMc3Vic2NyaXB0aW9uGAEgASgLMh0udG9pdC5hcGkucHVic3ViLlN1YnNjcmlwdGlvblIMc3Vic2NyaXB0aW9uEiEKDGVudmVsb3BlX2lkcxgCIAMoDFILZW52ZWxvcGVJZHM=');
