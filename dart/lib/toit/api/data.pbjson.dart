...
final $typed_data.Uint8List dataTypeDescriptor = $convert.base64Decode(
    'CghEYXRhVHlwZRILCgdVTktOT1dOEAASCAoETE9HUxABEgsKB01FVFJJQ1MQAhIOCgpUT1BJQ19EQVRBEAM=');
...
final $typed_data.Uint8List subscriptionDescriptor = $convert.base64Decode(
    'CgxTdWJzY3JpcHRpb24SJgoEdHlwZRgBIAEoDjISLnRvaXQuYXBpLkRhdGFUeXBlUgR0eXBlEhIKBG5hbWUYAiABKAlSBG5hbWU=');
...
final $typed_data.Uint8List messageDescriptor = $convert.base64Decode(
    'CgdNZXNzYWdlEg4KAmlkGAEgASgMUgJpZBIoCgdtZXNzYWdlGAIgASgLMg4udG9pdC5hcGkuRGF0YVIHbWVzc2FnZQ==');
...
final $typed_data.Uint8List createSubscriptionRequestDescriptor =
    $convert.base64Decode(
        'ChlDcmVhdGVTdWJzY3JpcHRpb25SZXF1ZXN0EjoKDHN1YnNjcmlwdGlvbhgBIAEoCzIWLnRvaXQuYXBpLlN1YnNjcmlwdGlvblIMc3Vic2NyaXB0aW9u');
...
final $typed_data.Uint8List createSubscriptionResponseDescriptor =
    $convert.base64Decode('ChpDcmVhdGVTdWJzY3JpcHRpb25SZXNwb25zZQ==');
...
final $typed_data.Uint8List deleteSubscriptionRequestDescriptor =
    $convert.base64Decode(
        'ChlEZWxldGVTdWJzY3JpcHRpb25SZXF1ZXN0EjoKDHN1YnNjcmlwdGlvbhgBIAEoCzIWLnRvaXQuYXBpLlN1YnNjcmlwdGlvblIMc3Vic2NyaXB0aW9u');
...
final $typed_data.Uint8List deleteSubscriptionResponseDescriptor =
    $convert.base64Decode('ChpEZWxldGVTdWJzY3JpcHRpb25SZXNwb25zZQ==');
...
final $typed_data.Uint8List listSubscriptionsRequestDescriptor =
    $convert.base64Decode(
        'ChhMaXN0U3Vic2NyaXB0aW9uc1JlcXVlc3QSJgoEdHlwZRgBIAEoDjISLnRvaXQuYXBpLkRhdGFUeXBlUgR0eXBlEhYKBm9mZnNldBgDIAEoDFIGb2Zmc2V0');
...
final $typed_data.Uint8List listSubscriptionsResponseDescriptor =
    $convert.base64Decode(
        'ChlMaXN0U3Vic2NyaXB0aW9uc1Jlc3BvbnNlEjwKDXN1YnNjcmlwdGlvbnMYASADKAsyFi50b2l0LmFwaS5TdWJzY3JpcHRpb25SDXN1YnNjcmlwdGlvbnMSHwoLbmV4dF9vZmZzZXQYAiABKAxSCm5leHRPZmZzZXQ=');
...
final $typed_data.Uint8List fetchRequestDescriptor = $convert.base64Decode(
    'CgxGZXRjaFJlcXVlc3QSOgoMc3Vic2NyaXB0aW9uGAEgASgLMhYudG9pdC5hcGkuU3Vic2NyaXB0aW9uUgxzdWJzY3JpcHRpb24SFAoFbGltaXQYAiABKAVSBWxpbWl0');
...
final $typed_data.Uint8List fetchResponseDescriptor = $convert.base64Decode(
    'Cg1GZXRjaFJlc3BvbnNlEi0KCG1lc3NhZ2VzGAEgAygLMhEudG9pdC5hcGkuTWVzc2FnZVIIbWVzc2FnZXM=');
...
final $typed_data.Uint8List streamRequestDescriptor = $convert.base64Decode(
    'Cg1TdHJlYW1SZXF1ZXN0EjoKDHN1YnNjcmlwdGlvbhgBIAEoCzIWLnRvaXQuYXBpLlN1YnNjcmlwdGlvblIMc3Vic2NyaXB0aW9u');
...
final $typed_data.Uint8List streamResponseDescriptor = $convert.base64Decode(
    'Cg5TdHJlYW1SZXNwb25zZRItCghtZXNzYWdlcxgBIAMoCzIRLnRvaXQuYXBpLk1lc3NhZ2VSCG1lc3NhZ2Vz');
...
final $typed_data.Uint8List acknowledgeRequestDescriptor = $convert.base64Decode(
    'ChJBY2tub3dsZWRnZVJlcXVlc3QSOgoMc3Vic2NyaXB0aW9uGAEgASgLMhYudG9pdC5hcGkuU3Vic2NyaXB0aW9uUgxzdWJzY3JpcHRpb24SHwoLbWVzc2FnZV9pZHMYAiADKAxSCm1lc3NhZ2VJZHM=');
...
final $typed_data.Uint8List acknowledgeResponseDescriptor =
    $convert.base64Decode('ChNBY2tub3dsZWRnZVJlc3BvbnNl');
...
final $typed_data.Uint8List dataDescriptor = $convert.base64Decode(
    '');
