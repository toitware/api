...
final $typed_data.Uint8List loginRequestDescriptor = $convert.base64Decode(
    'CgxMb2dpblJlcXVlc3QSGgoIdXNlcm5hbWUYASABKAlSCHVzZXJuYW1lEhoKCHBhc3N3b3JkGAIgASgJUghwYXNzd29yZBIaCghyZW1lbWJlchgDIAEoCFIIcmVtZW1iZXISJwoPb3JnYW5pemF0aW9uX2lkGAQgASgMUg5vcmdhbml6YXRpb25JZA==');
...
final $typed_data.Uint8List refreshRequestDescriptor = $convert.base64Decode(
    'Cg5SZWZyZXNoUmVxdWVzdBIjCg1yZWZyZXNoX3Rva2VuGAEgASgMUgxyZWZyZXNoVG9rZW4=');
...
final $typed_data.Uint8List authResponseDescriptor = $convert.base64Decode(
    'CgxBdXRoUmVzcG9uc2USIQoMYWNjZXNzX3Rva2VuGAEgASgMUgthY2Nlc3NUb2tlbhIdCgp0b2tlbl90eXBlGAIgASgJUgl0b2tlblR5cGUSOAoKZXhwaXJlc19pbhgDIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvblIJZXhwaXJlc0luEiMKDXJlZnJlc2hfdG9rZW4YBCABKAxSDHJlZnJlc2hUb2tlbg==');
...
final $typed_data.Uint8List changeOrganizationRequestDescriptor =
    $convert.base64Decode(
        'ChlDaGFuZ2VPcmdhbml6YXRpb25SZXF1ZXN0EicKD29yZ2FuaXphdGlvbl9pZBgBIAEoDFIOb3JnYW5pemF0aW9uSWQSIwoNcmVmcmVzaF90b2tlbhgCIAEoDFIMcmVmcmVzaFRva2Vu');
...
const CreateOrganizationRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.toit.api.CreateOrganizationRequest.Organization',
      '10': 'organization'
    },
    const {
      '1': 'user',
      ...
      '4': 1,
      '5': 11,
      '6': '.toit.api.CreateOrganizationRequest.User',
      '10': 'user'
    },
  ],
  '3': const [
    CreateOrganizationRequest_Organization$json,
    CreateOrganizationRequest_User$json
  ],
};
...
final $typed_data.Uint8List createOrganizationResponseDescriptor =
    $convert.base64Decode(
        'ChpDcmVhdGVPcmdhbml6YXRpb25SZXNwb25zZRInCg9vcmdhbml6YXRpb25faWQYASABKAxSDm9yZ2FuaXphdGlvbklk');
