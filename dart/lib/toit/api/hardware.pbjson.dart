...
final $typed_data.Uint8List claimResponseDescriptor = $convert.base64Decode(
    'Cg1DbGFpbVJlc3BvbnNlEj0KDWhhcmR3YXJlX2luZm8YASABKAsyGC50b2l0Lm1vZGVsLkhhcmR3YXJlSW5mb1IMaGFyZHdhcmVJbmZvEhsKCWRldmljZV9pZBgCIAEoDFIIZGV2aWNlSWQSHwoLZGV2aWNlX25hbWUYAyABKAlSCmRldmljZU5hbWUSJwoPb3JnYW5pemF0aW9uX2lkGAQgASgMUg5vcmdhbml6YXRpb25JZA==');
...
const ReplaceRequest$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'current_hardware_id',
      '3': 2,
      '4': 1,
      '5': 12,
      '10': 'currentHardwareId'
    },
...
final $typed_data.Uint8List replaceRequestDescriptor = $convert.base64Decode(
    'Cg5SZXBsYWNlUmVxdWVzdBImCg9uZXdfaGFyZHdhcmVfaWQYASABKAxSDW5ld0hhcmR3YXJlSWQSLgoTY3VycmVudF9oYXJkd2FyZV9pZBgCIAEoDFIRY3VycmVudEhhcmR3YXJlSWQSGwoJZGV2aWNlX2lkGAMgASgMUghkZXZpY2VJZBInCg9vcmdhbml6YXRpb25faWQYBCABKAxSDm9yZ2FuaXphdGlvbklk');
...
final $typed_data.Uint8List replaceResponseDescriptor = $convert.base64Decode(
    'Cg9SZXBsYWNlUmVzcG9uc2USPQoNaGFyZHdhcmVfaW5mbxgBIAEoCzIYLnRvaXQubW9kZWwuSGFyZHdhcmVJbmZvUgxoYXJkd2FyZUluZm8SJwoPb3JnYW5pemF0aW9uX2lkGAIgASgMUg5vcmdhbml6YXRpb25JZA==');
...
final $typed_data.Uint8List getActiveDeviceIDRequestDescriptor =
    $convert.base64Decode(
        'ChhHZXRBY3RpdmVEZXZpY2VJRFJlcXVlc3QSHwoLaGFyZHdhcmVfaWQYASABKAxSCmhhcmR3YXJlSWQ=');
...
final $typed_data.Uint8List getActiveDeviceIDResponseDescriptor =
    $convert.base64Decode(
        'ChlHZXRBY3RpdmVEZXZpY2VJRFJlc3BvbnNlEhsKCWRldmljZV9pZBgBIAEoDFIIZGV2aWNlSWQ=');
...
final $typed_data.Uint8List hardwareEventDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List hardwareEventsRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List hardwareEventsResponseDescriptor =
    $convert.base64Decode(
        'ChZIYXJkd2FyZUV2ZW50c1Jlc3BvbnNlEi0KBWV2ZW50GAEgASgLMhcudG9pdC5hcGkuSGFyZHdhcmVFdmVudFIFZXZlbnQ=');
...
const ClaimHardwareIdentityRequest$json = const {
  ...
  '2': const [
    const {
      '1': 'flash_station_secret',
      '3': 1,
      '4': 1,
      '5': 9,
      '10': 'flashStationSecret'
    },
  ],
};

/// Descriptor for `ClaimHardwareIdentityRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List claimHardwareIdentityRequestDescriptor =
    $convert.base64Decode(
        'ChxDbGFpbUhhcmR3YXJlSWRlbnRpdHlSZXF1ZXN0EjAKFGZsYXNoX3N0YXRpb25fc2VjcmV0GAEgASgJUhJmbGFzaFN0YXRpb25TZWNyZXQ=');
...
final $typed_data.Uint8List claimHardwareIdentityResponseDescriptor =
    $convert.base64Decode(
        'Ch1DbGFpbUhhcmR3YXJlSWRlbnRpdHlSZXNwb25zZRJJChFoYXJkd2FyZV9pZGVudGl0eRgBIAEoCzIcLnRvaXQubW9kZWwuSGFyZHdhcmVJZGVudGl0eVIQaGFyZHdhcmVJZGVudGl0eQ==');
...
const SetHardwareIdentityInfoRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.toit.model.HardwareIdentityInfo',
      '10': 'info'
    },
  ],
};
...
final $typed_data.Uint8List setHardwareIdentityInfoRequestDescriptor =
    $convert.base64Decode(
        'Ch5TZXRIYXJkd2FyZUlkZW50aXR5SW5mb1JlcXVlc3QSMAoUZmxhc2hfc3RhdGlvbl9zZWNyZXQYASABKAlSEmZsYXNoU3RhdGlvblNlY3JldBIfCgtoYXJkd2FyZV9pZBgCIAEoDFIKaGFyZHdhcmVJZBI0CgRpbmZvGAMgASgLMiAudG9pdC5tb2RlbC5IYXJkd2FyZUlkZW50aXR5SW5mb1IEaW5mbw==');
...
final $typed_data.Uint8List setHardwareIdentityInfoResponseDescriptor =
    $convert.base64Decode('Ch9TZXRIYXJkd2FyZUlkZW50aXR5SW5mb1Jlc3BvbnNl');
