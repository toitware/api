...
class CreateAppRequest_Files extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $core.List<$core.int>>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'files',
        entryClassName: 'CreateAppRequest.Files.FilesEntry',
  ...
  factory CreateAppRequest_Files.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CreateAppRequest_Files.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  CreateAppRequest_Files clone() =>
      CreateAppRequest_Files()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CreateAppRequest_Files copyWith(
          void Function(CreateAppRequest_Files) updates) =>
      super.copyWith((message) => updates(message as CreateAppRequest_Files))
          as CreateAppRequest_Files; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CreateAppRequest_Files create() => CreateAppRequest_Files._();
  CreateAppRequest_Files createEmptyInstance() => create();
  static $pb.PbList<CreateAppRequest_Files> createRepeated() =>
      $pb.PbList<CreateAppRequest_Files>();
  @$core.pragma('dart2js:noInline')
  static CreateAppRequest_Files getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CreateAppRequest_Files>(create);
...
enum CreateAppRequest_Source { files, bundle, notSet }

class CreateAppRequest extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, CreateAppRequest_Source>
      _CreateAppRequest_SourceByTag = {
    6: CreateAppRequest_Source.files,
    7: CreateAppRequest_Source.bundle,
    0: CreateAppRequest_Source.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateAppRequest',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'toit.api'),
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'namespace')
    ..a<$fixnum.Int64>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revision', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..m<$core.String, $1.JobSpec>(
        5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobs',
        entryClassName: 'CreateAppRequest.JobsEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: $1.JobSpec.create,
        packageName: const $pb.PackageName('toit.api'))
    ..aOM<CreateAppRequest_Files>(
        6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'files',
        subBuilder: CreateAppRequest_Files.create)
  ...
  factory CreateAppRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CreateAppRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  CreateAppRequest copyWith(void Function(CreateAppRequest) updates) =>
      super.copyWith((message) => updates(message as CreateAppRequest))
          as CreateAppRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  CreateAppRequest_Source whichSource() =>
      _CreateAppRequest_SourceByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(6)
  set files(CreateAppRequest_Files v) {
    setField(6, v);
  }
...
class CreateAppResponse extends $pb.GeneratedMessage {
  ...
  factory CreateAppResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CreateAppResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  CreateAppResponse copyWith(void Function(CreateAppResponse) updates) =>
      super.copyWith((message) => updates(message as CreateAppResponse))
          as CreateAppResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set appId($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
...
class GetAppRequest extends $pb.GeneratedMessage {
  ...
  factory GetAppRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetAppRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  GetAppRequest copyWith(void Function(GetAppRequest) updates) =>
      super.copyWith((message) => updates(message as GetAppRequest))
          as GetAppRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetAppRequest create() => GetAppRequest._();
  GetAppRequest createEmptyInstance() => create();
  static $pb.PbList<GetAppRequest> createRepeated() =>
      $pb.PbList<GetAppRequest>();
  @$core.pragma('dart2js:noInline')
...
class GetAppResponse extends $pb.GeneratedMessage {
  ...
  factory GetAppResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetAppResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetAppResponse copyWith(void Function(GetAppResponse) updates) =>
      super.copyWith((message) => updates(message as GetAppResponse))
          as GetAppResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetAppResponse create() => GetAppResponse._();
  GetAppResponse createEmptyInstance() => create();
  static $pb.PbList<GetAppResponse> createRepeated() =>
      $pb.PbList<GetAppResponse>();
  @$core.pragma('dart2js:noInline')
  static GetAppResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetAppResponse>(create);
...
class GetAppFilesRequest extends $pb.GeneratedMessage {
  ...
  factory GetAppFilesRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetAppFilesRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetAppFilesRequest copyWith(void Function(GetAppFilesRequest) updates) =>
      super.copyWith((message) => updates(message as GetAppFilesRequest))
          as GetAppFilesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetAppFilesRequest create() => GetAppFilesRequest._();
  GetAppFilesRequest createEmptyInstance() => create();
  static $pb.PbList<GetAppFilesRequest> createRepeated() =>
      $pb.PbList<GetAppFilesRequest>();
  @$core.pragma('dart2js:noInline')
  static GetAppFilesRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetAppFilesRequest>(create);
...
class GetAppFilesResponse_Entry extends $pb.GeneratedMessage {
  ...
  factory GetAppFilesResponse_Entry.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetAppFilesResponse_Entry.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  GetAppFilesResponse_Entry clone() =>
      GetAppFilesResponse_Entry()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetAppFilesResponse_Entry copyWith(
          void Function(GetAppFilesResponse_Entry) updates) =>
      super.copyWith((message) => updates(message as GetAppFilesResponse_Entry))
          as GetAppFilesResponse_Entry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetAppFilesResponse_Entry create() => GetAppFilesResponse_Entry._();
  GetAppFilesResponse_Entry createEmptyInstance() => create();
  static $pb.PbList<GetAppFilesResponse_Entry> createRepeated() =>
      $pb.PbList<GetAppFilesResponse_Entry>();
  @$core.pragma('dart2js:noInline')
  static GetAppFilesResponse_Entry getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetAppFilesResponse_Entry>(create);
...
class GetAppFilesResponse_Directory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
          : 'GetAppFilesResponse.Directory',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'toit.api'),
      createEmptyInstance: create)
    ..pc<GetAppFilesResponse_Entry>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'entries',
        $pb.PbFieldType.PM,
        subBuilder: GetAppFilesResponse_Entry.create)
    ..hasRequiredFields = false;
  ...
  factory GetAppFilesResponse_Directory.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetAppFilesResponse_Directory.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  GetAppFilesResponse_Directory clone() =>
      GetAppFilesResponse_Directory()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetAppFilesResponse_Directory copyWith(
          void Function(GetAppFilesResponse_Directory) updates) =>
      super.copyWith(
              (message) => updates(message as GetAppFilesResponse_Directory))
          as GetAppFilesResponse_Directory; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetAppFilesResponse_Directory create() =>
      GetAppFilesResponse_Directory._();
  GetAppFilesResponse_Directory createEmptyInstance() => create();
  static $pb.PbList<GetAppFilesResponse_Directory> createRepeated() =>
      $pb.PbList<GetAppFilesResponse_Directory>();
  @$core.pragma('dart2js:noInline')
  static GetAppFilesResponse_Directory getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetAppFilesResponse_Directory>(create);
...
enum GetAppFilesResponse_Result { directory, fileContent, notSet }

class GetAppFilesResponse extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, GetAppFilesResponse_Result>
      _GetAppFilesResponse_ResultByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<GetAppFilesResponse_Directory>(1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'directory',
        subBuilder: GetAppFilesResponse_Directory.create)
    ..a<$core.List<$core.int>>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory GetAppFilesResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetAppFilesResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetAppFilesResponse copyWith(void Function(GetAppFilesResponse) updates) =>
      super.copyWith((message) => updates(message as GetAppFilesResponse))
          as GetAppFilesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetAppFilesResponse create() => GetAppFilesResponse._();
  GetAppFilesResponse createEmptyInstance() => create();
  static $pb.PbList<GetAppFilesResponse> createRepeated() =>
      $pb.PbList<GetAppFilesResponse>();
  @$core.pragma('dart2js:noInline')
  static GetAppFilesResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetAppFilesResponse>(create);
  static GetAppFilesResponse? _defaultInstance;

  GetAppFilesResponse_Result whichResult() =>
      _GetAppFilesResponse_ResultByTag[$_whichOneof(0)]!;
  void clearResult() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  GetAppFilesResponse_Directory get directory => $_getN(0);
  @$pb.TagNumber(1)
  set directory(GetAppFilesResponse_Directory v) {
    setField(1, v);
  }
...
class ListAppsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'limit')
    ..e<ListAppsRequest_OrderBy>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orderBy', $pb.PbFieldType.OE,
        defaultOrMaker: ListAppsRequest_OrderBy.ADDED_ID,
        valueOf: ListAppsRequest_OrderBy.valueOf,
        enumValues: ListAppsRequest_OrderBy.values)
  ...
  factory ListAppsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ListAppsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  ListAppsRequest copyWith(void Function(ListAppsRequest) updates) =>
      super.copyWith((message) => updates(message as ListAppsRequest))
          as ListAppsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set orderBy(ListAppsRequest_OrderBy v) {
    setField(3, v);
  }
...
class ListAppsFilter extends $pb.GeneratedMessage {
  ...
  factory ListAppsFilter.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ListAppsFilter.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ListAppsFilter copyWith(void Function(ListAppsFilter) updates) =>
      super.copyWith((message) => updates(message as ListAppsFilter))
          as ListAppsFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ListAppsFilter create() => ListAppsFilter._();
  ListAppsFilter createEmptyInstance() => create();
  static $pb.PbList<ListAppsFilter> createRepeated() =>
      $pb.PbList<ListAppsFilter>();
  @$core.pragma('dart2js:noInline')
  static ListAppsFilter getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ListAppsFilter>(create);
  ...
  @$pb.TagNumber(3)
  set namespacePrefix($core.String v) {
    $_setString(2, v);
  }
...
class ListAppsResponse extends $pb.GeneratedMessage {
  ...
  factory ListAppsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ListAppsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  ListAppsResponse copyWith(void Function(ListAppsResponse) updates) =>
      super.copyWith((message) => updates(message as ListAppsResponse))
          as ListAppsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
