...
class ReleaseLevel_Type extends $pb.ProtobufEnum {
  static const ReleaseLevel_Type UNKNOWN = ReleaseLevel_Type._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  static const ReleaseLevel_Type RELEASED = ReleaseLevel_Type._(
      10,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'RELEASED');
  static const ReleaseLevel_Type BETA = ReleaseLevel_Type._(
      20,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'BETA');
  static const ReleaseLevel_Type ALPHA = ReleaseLevel_Type._(
      30,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ALPHA');
  static const ReleaseLevel_Type EDGE = ReleaseLevel_Type._(
      40,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'EDGE');
  ...
  static final $core.Map<$core.int, ReleaseLevel_Type> _byValue =
