...
class App extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'name')
    ..aOS(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'namespace')
  ...
  @$pb.TagNumber(8)
  set createdBy($core.List<$core.int> v) {
    $_setBytes(7, v);
  }
...
class JobSpec_PubSub extends $pb.GeneratedMessage {
  ...
  factory JobSpec_PubSub.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory JobSpec_PubSub.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  JobSpec_PubSub copyWith(void Function(JobSpec_PubSub) updates) =>
      super.copyWith((message) => updates(message as JobSpec_PubSub))
          as JobSpec_PubSub; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static JobSpec_PubSub create() => JobSpec_PubSub._();
  JobSpec_PubSub createEmptyInstance() => create();
  static $pb.PbList<JobSpec_PubSub> createRepeated() =>
      $pb.PbList<JobSpec_PubSub>();
  @$core.pragma('dart2js:noInline')
  static JobSpec_PubSub getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<JobSpec_PubSub>(create);
...
class JobSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'JobSpec',
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'toit.model'),
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'entrypoint')
    ..aOM<$1.JobResources>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resources',
        subBuilder: $1.JobResources.create)
    ..aOM<$1.JobTriggers>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'triggers',
        subBuilder: $1.JobTriggers.create)
    ..aOM<JobSpec_PubSub>(
        5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubsub',
        subBuilder: JobSpec_PubSub.create)
    ..pc<$1.JobFile>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'files', $pb.PbFieldType.PM,
        subBuilder: $1.JobFile.create)
    ..hasRequiredFields = false;
  ...
  factory JobSpec.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory JobSpec.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  JobSpec copyWith(void Function(JobSpec) updates) =>
      super.copyWith((message) => updates(message as JobSpec))
          as JobSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static JobSpec getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<JobSpec>(create);
  ...
  @$pb.TagNumber(3)
  set resources($1.JobResources v) {
    setField(3, v);
  }
