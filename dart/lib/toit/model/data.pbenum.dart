...
class MetricsData_Level extends $pb.ProtobufEnum {
  static const MetricsData_Level DEBUG_LEVEL = MetricsData_Level._(
      0,
  ...
  static const MetricsData_Level INFO_LEVEL = MetricsData_Level._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'INFO_LEVEL');
  static const MetricsData_Level CRITICAL_LEVEL = MetricsData_Level._(
      10,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'CRITICAL_LEVEL');
  ...
  static final $core.Map<$core.int, MetricsData_Level> _byValue =
...
class LogData_Type extends $pb.ProtobufEnum {
  static const LogData_Type UNKNOWN = LogData_Type._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  static const LogData_Type PRINT = LogData_Type._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PRINT');
  static const LogData_Type PROCESS_START = LogData_Type._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PROCESS_START');
  static const LogData_Type PROCESS_STOP = LogData_Type._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PROCESS_STOP');
  static const LogData_Type STACK_TRACE = LogData_Type._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'STACK_TRACE');
  static const LogData_Type BOOT = LogData_Type._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'BOOT');
  static const LogData_Type SHUTDOWN = LogData_Type._(
      6,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SHUTDOWN');
  ...
  static final $core.Map<$core.int, LogData_Type> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class LogData_Level extends $pb.ProtobufEnum {
  static const LogData_Level PRINT_LEVEL = LogData_Level._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PRINT_LEVEL');
  static const LogData_Level DEBUG_LEVEL = LogData_Level._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DEBUG_LEVEL');
  static const LogData_Level INFO_LEVEL = LogData_Level._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'INFO_LEVEL');
  static const LogData_Level WARN_LEVEL = LogData_Level._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WARN_LEVEL');
  ...
  static final $core.Map<$core.int, LogData_Level> _byValue =
      $pb.ProtobufEnum.initByValue(values);
